...
class ServerGUI:
    def __init__(self, root):
        ...
        # --- HEADER ---
        header = ttk.Label(root, text="Python Secure Chat Server", style="Header.TLabel")
        header.pack(pady=10)
        ...
        ttk.Button(button_frame, text="🚀 Server Başlat", command=self.start_server).grid(row=0, column=1, padx=5)
